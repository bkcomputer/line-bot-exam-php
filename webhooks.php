...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		//
		if ( ($event['source']['userId'] == "Ue5012e668f8c66f02959ac9c23cc3d4b") && $event['type'] == 'message' && $event['message']['type'] == 'text'  ) {     //    && strpos($event['message']['text'], 'due') !== false     || $event['source']['userId'] == "Ue5012e668f8c66f02959ac9c23cc3d4b"   //&& (strpos($event['message']['text'], 'due') !== false)
			// Get text sent
